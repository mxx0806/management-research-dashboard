...
def load_data():
    data = [
        ...
        ["红组", "湖南大学", "工商管理学院", "管理研究方法论", 2, 32, "全日制学术型硕士（工商+会计）", "线下", 50, "否",
         "课程设置为四个学院的老师授课，每个老师讲两周，不同专业的老师对研究方法论讲解有自己的重点(老师来自学院组织创新与战略系、市场学系、管理科学与商业智能系)", 
         "无", "无", "—", "平时作业＋期末作业", "否", "无", "无", ""],
        ...
        ["红组", "北京外国语大学", "国际商学院", "管理研究方法", 2, 32, "工商管理一级学科硕士", "线下", "—", "否",
         "1）完成文献综述写作；（2）完成问卷调查、实验研究、二手数据研究的模仿性研究论文。（3）掌握 SPSS、PLS 等统计学软件在几种研究方法中的应用。", 
         "Chapter1-Chapter6 经管研究方法：为学生量身定制（第五版）", "SPSS、PLS", "—", "完成个人研究计划书", "是", "否", "否", 
         "北京外国语大学工商管理一级学科硕士研究生培养方案.pdf"],
        ["红组", "北京邮电大学", "经济管理学院", "管理科学研究方法", 2, 32, "全日制学术型硕士", "混合", 80, "是",
         "老师讲解与学校开发的智能体'码上'结合教学", "无", "AI", "50/50", "课程报告与开卷考试", "是", "否", "否",
         "https://mp.weixin.qq.com/s?__biz=MzA5MTY3MzAxOQ==&mid=2650704700&idx=3&sn=812779487eef3a5208bde0d009f8573c&chksm=8872f3e8bf057afefecd646e4ee167db520e8e4113b96a2809b9539edff35100688639003a15&scene=27"],
        ["红组", "河北工业大学", "经济管理学院", "研究方法II（管理研究方法）", 3, 32, "全日制学术型硕士", "混合", "—", "否",
         "混合式教学线索沿'基础模块→进阶模块→反思模块'延展，线上铺垫式激疑重思考，线下项目式推进重探究；线上采用观看企业家和学者演说等形式，引起学生对现实情境与问题的重视；线下课堂运用探究式教学法实现翻转", 
         "无", "无", "—", "过程形成性评价", "否", "否", "否", 
         "https://mp.weixin.qq.com/s?__biz=MzIxMzMyMjQ0Mg==&mid=2247520534&idx=1&sn=7b02452fad3c7b7f34bbc64d644a000e&chksm=97ba4eb3a0cdc7a502a846c08c579af753da3b1d640817ee04be76549ebead24cc2710227508&scene=27"],
        ["红组", "对外经济贸易大学", "政府管理学院", "公共管理研究方法", 2, 32, "公共管理学、理论经济学、应用经济学硕士",
         "线下", "—", "否", "从方法论上，本课程侧重于因果关系识别的研究设计和经验策略；从具体方法与技术上，课程教学以统计与计量方法为主进行因果推断，并学习应用统计软件Stata进行操作，加深原理认识及提高应用能力，为未来实证论文写作奠定坚实基础、为未来职业的潜在应用提供工具支持。", 
         "无", "Stata、AI", "—", "期末课程论文", "是", "否", "否", "http://gmis.uibe.edu.cn/graduate/portalcourse/courseDetail.do?id=17387"],
        
        # 蓝组数据（10条）
        ["蓝组", "兰州大学", "管理学院", "管理研究方法论", 2, 12, "全日制学术型硕士", "线下", 40, "否",
         "课前阅读相关论文", "无", "无", "0.25", "撰写一篇本课所读论文的阅读笔记，不少于2000字", "否", "否", "否", ""],
        ["蓝组", "中国科学院大学", "经济与管理学院", "管理研究方法论", 3, 54, "MPA", "线下", "—", "否",
         "一级学科核心课，面向公共管理专业硕士", "无", "无", "—", "—", "否", "否", "否", ""],
        ["蓝组", "郑州大学", "经济与管理学院", "管理研究方法论", 2, 32, "硕士生", "线下", "—", "否",
         "采用'理论讲授+案例分析'模式，强调研究全过程训练", "翟运开《管理研究方法论》", "无", "—", "课程论文", "否", "否", "否", ""],
        ["蓝组", "西安交通大学", "管理学院", "高级管理研究", 2, 32, "全日制学术型硕士，MBA", "线下", "约110", "是",
         "小组汇报，案例分析", "《高级管理学》", "无", "40/60", "考试+小组汇报+报告", "否", "否", "是", ""],
        ["蓝组", "哈尔滨工业大学", "经济管理学院", "管理研究方法", 2, 32, "在校留学生（经济管理人文国际硕士项目）",
         "线下", "—", "是", "阅读顶级期刊论文、制作PPT讲解、使用社交媒体平台交流", "无", "SPSS、AMOS、SmartPLS 等", "60/40",
         "论文阅读与讨论、研究计划（Proposal）、期末考试", "是", "是", "是", "https://max.book118.com/html/2018/0426/163160180.shtm"],
        ["蓝组", "长安大学", "经济管理学院", "管理前沿理论", "", 32, "全日制学术型硕士", "线下", "约60", "是",
         "小组汇报，案例分析", "无", "无", "", "开题报告", "否", "是", "否", ""],
        ["蓝组", "中国矿业大学", "经济管理学院", "管理研究方法论", 2, 32, "全日制学术型硕士", "线下", 80, "是",
         "小组对课程某一板块进行汇报", "无", "无", "40/60", "期末课程论文", "否", "否", "否", ""],
        ["蓝组", "苏州大学", "商学院", "管理研究方法论", 2, 32, "全日制学术型硕士", "线下", "约60", "是",
         "案例讨论", "《管理学研究方法》", "spss、stata", "40/60", "期末课程论文", "是", "否", "否", ""],
        ["蓝组", "同济大学", "经济管理学院", "管理研究方法论", 2, 32, "全日制学术型硕士", "线下", 50, "是",
         "案例分析、个人展示", "无", "无", "40/60", "期末课程论文", "否", "否", "否", ""],
        ["蓝组", "华东师范大学", "经济管理学院", "管理研究方法论", 2, 32, "全日制学术型硕士", "线下", 60, "是",
         "案例分析", "无", "无", "40/60", "期末课程论文", "是", "否", "否", ""]
    ]
    ...
    # 数据清洗
    # 处理课堂规模中的约、—等符号
    df["课堂规模"] = df["课堂规模"].replace(["—", "-", "─", "", "约"], np.nan)
    # 提取数字部分
    df["课堂规模"] = df["课堂规模"].str.extract(r'(\d+)').astype(float)
    ...
    # 清理平时/期末权重列
    df["平时/期末权重"] = df["平时/期末权重"].replace(["—", "-", ""], np.nan)
    ...
    for idx, tools in df["软件工具"].dropna().items():
        if isinstance(tools, str):
            # 处理多种分隔符：顿号、逗号、空格
            for tool in tools.replace("、", ",").replace("，", ",").split(","):
                tool = tool.strip()
                if tool and tool.lower() != "无" and tool != "等":
    ...
    university_locations = {
        "高校": ["中国农业大学", "东南大学", "南京师范大学", "湖南大学", "上海财经大学", 
                "厦门大学", "北京外国语大学", "北京邮电大学", "河北工业大学", "对外经济贸易大学",
                "兰州大学", "中国科学院大学", "郑州大学", "西安交通大学", "哈尔滨工业大学",
                "长安大学", "中国矿业大学", "苏州大学", "同济大学", "华东师范大学"],
        "城市": ["北京", "南京", "南京", "长沙", "上海", 
                "厦门", "北京", "北京", "天津", "北京",
                "兰州", "北京", "郑州", "西安", "哈尔滨",
                "西安", "徐州", "苏州", "上海", "上海"],
        "经度": [116.4074, 118.7969, 118.7969, 112.9388, 121.4737, 
                118.0894, 116.4074, 116.4074, 117.2010, 116.4074,
                103.8340, 116.4074, 113.6654, 108.9480, 126.6425,
                108.9480, 117.2841, 120.5853, 121.4737, 121.4737],
        "纬度": [39.9042, 32.0603, 32.0603, 28.2282, 31.2304, 
                24.4795, 39.9042, 39.9042, 39.0842, 39.9042,
                36.0611, 39.9042, 34.7580, 34.2636, 45.7569,
                34.2636, 34.2057, 31.2990, 31.2304, 31.2304]
    }
